...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        // Jika username sudah ada, tampilkan model popup "Username sudah digunakan"
        $error_message = "Username sudah digunakan.";
    } else {
        // Jika username belum ada, tambahkan data ke database
        $insert_query = "INSERT INTO user (username, password) VALUES ('$username', '$password')";
        if (mysqli_query($connection, $insert_query)) {
            // Jika data berhasil ditambahkan, tampilkan model popup "Anda berhasil login"
            $success_message = "Anda berhasil sign up.";
            $showContinueButton = true; // Tampilkan tombol "Continue your book?"
        } else {
        ...
        <div class="masuk">
            ...
            <form method="POST" action="loginuser.php">
				...
				<div class="button-container">
					<button class="btn btn-primary mt-3" type="submit" name="submit">Sign Up</button>
					<a href="signup.php" class="btn btn-primary mt-3">Already have account?</a>
                </div>
            </form>
        </div>
        <div class="masuk">
