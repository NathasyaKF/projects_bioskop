...
// Ambil username dan movie_id dari URL
...
<head>
    ...
    <title>Movie Details - <?php echo htmlspecialchars($movie['judul']); ?></title>
    <style>
    .navbar {
        height: 100px;
...
<body>
                ...
                <div class="kanan">
                    <?php if ($movie) { ?>
                        ...
                        <div class="button-container">
                            <a href="ticketbuyUser.php?movie_id=<?php echo $movie['movie_id']; ?>&username=<?php echo $username; ?>" class="btn-custom">Buy Ticket</a>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js" integrity="sha384-IQsoLXlDZ/Q7zL+971GA1e3KCjv0J6PRpL+8/1jWLjFjBjoz0tV7RE+kH0u8j6DZ" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiL8yWv4K6AHUAdkO8bAeEl6Dk5iDkRZlNHJw6Nui1zWrlrP8sH8e6N8j" crossorigin="anonymous"></script>
</body>
